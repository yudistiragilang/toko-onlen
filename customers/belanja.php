				...
				<tbody>
					...
					?>
								<tr>
									...
									<td>
										<a class="btn red" href="?order_id=<?php echo $row['order_id']; ?>" onclick="return confirm('Apakah Anda Yakin?')"><i class="large material-icons">delete</i></a>
									</td>
								</tr>
						<?php
								$no++;
						...
						<tr>
							...
							<td><a href="?order=<?php echo $user_id; ?>" class="btn green" onclick=" return confirm('Pastikan pesanan anda sudah benar !')">order</a></td>
						</tr>
				</tbody>
			</table>
		</div>
